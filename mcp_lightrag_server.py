...
class LightRAGHTTPServer:
    ...
    async def initialize(self):
        ...
        EXTRACTION_PROMPT = (
            ...
            "4. ЗАПРЕЩЕНО добавлять любые другие поля в объекты 'entities' или 'relationships'.\n"
            "5. ЗАПРЕЩЕНО опускать обязательные поля.\n"
            "6. Если сущностей нет — верни {\"entities\": [], \"relationships\": []}.\n\n"
            "Формат ответа:\n"
        ...
        GENERATION_PROMPT = (
            ...
            "Формат: Текст без заголовков, списков или маркированных пунктов. "
            "Стиль: Нейтральный, научно-популярный, доступный широкому кругу читателей. "
            "Длина: 2-4 предложения или 1 абзац, не более 400 слов. "
